...
- When outcome is continuous (i.e., monthly pay), the univariate visualization I've selected is histogram to allow users to visualize the frequency distribution of the variable. On the other hand, when outcome variable is discrete (i.e., turnover/attrition and job satisfaction), I used bar graphs as a form of univariate distribution to show the counts of employees who had either turnover or stayed in the company as we as number of employees giving different job satisfaction ratings. \ 
